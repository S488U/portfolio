...
const Contact = () => {
  ...
  return (
    <div
      id="contact"
      className="w-full max-h-fit flex flex-col justify-around items-center overflow-hidden scroll-mt-18 md:scroll-mt-14 my-8 p-4 pt-4 mt-12"
    >
      <div className="w-full max-w-5xl space-y-4">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="order-2 md:order-1 mt-2 bg-white text-black p-3 pb-5">
            <h1 className="font-medium text-2xl font-nature pt-4 px-2">
          ...
          <div className="order-1 md:order-2 mt-2 bg-white text-black p-3 pb-5">
            <h1 className="font-medium text-2xl font-nature pt-4 px-2">
              Mail me from the web:
            </h1>
            <form
              onSubmit={formSubmit}
              className="flex flex-col mt-5 gap-y-3 w-75 ml-0 md:ml-16"
            >
              <div className="flex flex-col justify-start items-start form-control">
                <label className="text-grey text-sm" htmlFor="name">
                  Enter your name:
                </label>
                <input
                  name="name"
                  id="name"
                  type="text"
                  className="text-black text-lg border-4 border-black focus:outline-hidden px-3 py-2 w-full"
                  value={formData.name}
              ...
              <div className="flex flex-col justify-start items-start form-control">
                <label className="text-grey text-sm" htmlFor="email">
                  Enter your email:
                </label>
                <input
                  name="email"
              ...
              <div className="flex flex-col justify-start items-start form-control">
                <label className="text-grey text-sm" htmlFor="message">
                  Enter your message:
                </label>
                <textarea
                  name="message"
              ...
              <div className="flex flex-col justify-start items-start">
                <motion.input
                  ...
                  type="submit"
                  value="send"
                  className={`font-naturebg text-lg border-4 focus:outline-hidden px-3 py-2 w-full transition-colors duration-200 ${
                    isSubmit
                      ? "text-white  bg-black border-black cursor-pointer"
                      : "text-zinc-200 bg-zinc-700 border-zinc-700 cursor-not-allowed"
                  }`}
        ...
        <p className="text-sm text-grey text-center">
          Relax, your name and email are safer than your pizza delivery
          guy&apos;s secret sauce recipe. No sharing here! 😄
        </p>
        <BreakLine />
      </div>
    </div>
