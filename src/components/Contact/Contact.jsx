                    ...
                    <div className="order-1 md:order-2 mt-2 bg-white text-black p-3 pb-5">
                        ...
                        <form className="flex flex-col mt-5 gap-y-3 w-[300px] ml-0 md:ml-16">
                            ...
                            <div className="flex flex-col justify-start items-start">
                                ...
                                <input id="name" type="text" className="text-black text-lg border-4 border-black focus:outline-none px-3 py-2 w-full" />
                            </div>
                            {/* Email */}
                            <div className="flex flex-col justify-start items-start">
                                <label className="text-grey text-sm " htmlFor="email">Enter your email:</label>
                                <input id="email" type="text" className="text-black text-lg border-4 border-black focus:outline-none px-3 py-2 w-full" />
                            </div>
                            {/* Message */}
                            <div className="flex flex-col justify-start items-start ">
                                <label className="text-grey text-sm " htmlFor="message">Enter your message:</label>
                                <textarea id="message" className="text-black text-lg border-4 border-black focus:outline-none px-3 py-2 w-full"></textarea>
                            </div>
                            {/* Submit */}
                            <div className="flex flex-col justify-start items-start ">
