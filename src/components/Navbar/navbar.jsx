const navbar = () => {
  return (
    <header className='w-full flex justify-center align-center items-center mt-4 bg-transparent fixed'>
        <navbar className='shadow-md flex flex justify-center align-center items-center gap-3 text-lg p-3 border border-[3px] border-solid border-black bg-white rounded-full relative z-999'>
